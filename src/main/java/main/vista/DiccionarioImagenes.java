...
public class DiccionarioImagenes {
    ...
    public DiccionarioImagenes() {
        ...
        ImageView imgSoldado = new ImageView("file:src/img/soldado.png");
        imgSoldado.setFitHeight(ALTURA_UNIDAD);
        imgSoldado.setFitWidth(ANCHURA_UNIDAD);

        ImageView imgJinete = new ImageView("file:src/img/jinete.gif");
        ...
        ImageView imgCatapulta = new ImageView("file:src/img/catapulta.gif");
